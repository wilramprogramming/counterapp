 ...
 * @author Shai Almog
 */
public class MyRADAppStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "MyRADApp";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new MyRADAppStub());
    }
