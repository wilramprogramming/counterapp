 ...
 * @author Shai Almog
 */
public class CounterAppStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "CounterApp";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new CounterAppStub());
    }
